...
must_haves:
  ...
  artifacts:
    ...
    - path: "internal/todo/repository.go"
      ...
      exports: "ListTodos, SearchTodos, FilterByDateRange, PinTodo, ListAllForExport"
    - path: "internal/todo/service.go"
      provides: "ListTodos/ListTodosByDateRange/PinTodo/ExportTodos业务逻辑"
      exports: "ListTodos, ListTodosByDateRange, PinTodo, ExportTodos"
    - path: "internal/todo/handler.go"
      provides: "ListTodos/ExportTodos端点"
      exports: "GET /todos, GET /todos/export"
    - path: "internal/todo/router.go"
      provides: "todo路由注册"
      exports: "/todos CRUD路由"
    - path: "internal/todo/excel.go"
      provides: "待办列表Excel导出"
      exports: "ExportTodos函数"
    - path: "frontend/src/api/todo.ts"
      provides: "待办API客户端"
      exports: "listTodos, exportTodos, pinTodo"
...
- internal/todo/repository.go（列表/搜索/筛选/置顶/导出）
...
func (h *Handler) ListCarousels(c *gin.Context) {
	...
	// TODO: implement carousel CRUD via service — for now return empty
...
注意：main.go 中已经存在 dashboard router 注册，需要确认 todo router 的注册方式。检查 main.go 中的路由注册模式，在同一位置添加 todo router。
  ...
  <acceptance_criteria>
    ...
    - [ ] internal/todo/repository.go exists with ListTodos, SearchTodos, FilterByDateRange, PinTodo, ListAllForExport methods
    - [ ] internal/todo/service.go exists with ListTodos, PinTodo, ExportTodos, CreateTodo methods
    - [ ] internal/todo/handler.go exists with ListTodos and PinTodo handlers
    - [ ] internal/todo/router.go registers /todos and /carousels routes
...
- 已终止: #8C8C8C
  ...
  <acceptance_criteria>
    - [ ] frontend/src/api/todo.ts exists with listTodos, pinTodo, exportTodos functions
