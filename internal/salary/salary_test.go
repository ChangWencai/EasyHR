...
func TestSalaryTemplateCRUD(t *testing.T) {
	...
	templateRepo := NewSalaryTemplateRepository(db)
	svc := NewService(nil, templateRepo, nil, nil, nil, nil, nil, nil, nil, testutil.TestCryptoConfig(), nil)
...
func TestSalaryItemCRUD(t *testing.T) {
	...
	templateRepo := NewSalaryTemplateRepository(db)
	svc := NewService(repo, templateRepo, nil, nil, nil, nil, nil, nil, nil, testutil.TestCryptoConfig(), nil)
