...
func TestSalaryTemplateCRUD(t *testing.T) {
	...
	templateRepo := NewSalaryTemplateRepository(db)
	svc := NewService(nil, templateRepo, nil, nil, nil, nil, nil, nil, nil, testutil.TestCryptoConfig())
...
func TestSalaryItemCRUD(t *testing.T) {
	...
	templateRepo := NewSalaryTemplateRepository(db)
	svc := NewService(repo, templateRepo, nil, nil, nil, nil, nil, nil, nil, testutil.TestCryptoConfig())
